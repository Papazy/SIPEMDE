...
import {buttonAddUser,AddUserForm } from 'components/buttonAddUser/buttonAddUser';
...
function CheckTable(props: { tableData: any }) {
  ...
  const columns = [
    columnHelper.accessor('nik', {
      id: 'nik',
      header: () => (
        <p className="text-sm font-bold text-gray-600 dark:text-white">NIK</p>
      ),
      cell: (info) => (
  ...
  return (
    <Card extra={'w-full h-full sm:overflow-auto px-6'}>
      <header className="relative flex items-center justify-between pt-4">
        ...
        <button className="bg-green-500 hover:bg-blue-700 text-white font-bold text-sm py-2 px-2 rounded">
      + Add User
    </button>
      </header>
